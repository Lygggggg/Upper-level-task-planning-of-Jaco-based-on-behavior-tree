...
#include <robot_grasp/VFH_pick_place.h>
#include "robot_grasp/G_pick_place.h"
namespace kinova
{
...
//        robot_state::RobotStatePtr robot_state_;
        ...
        geometry_msgs::PoseStamped intermedia_pt_0,intermedia_pt_1,intermedia_pt_2,intermedia_pt_3,intermedia_pt_4,intermedia_pt_5;
        geometry_msgs::PoseStamped obj_place_pose,pre_obj_place_pose;
        geometry_msgs::PoseStamped obj_pre_grasp_pose;
        geometry_msgs::PoseStamped obj_grasp_pose;
        geometry_msgs::PoseStamped new_obj_grasp_pose;
        geometry_msgs::PoseStamped new_obj_place_pose;
        ...
        int num_of_label;
        std::vector<float> detected_param_obj_list;

        moveit::planning_interface::MoveGroupInterface::Plan kinova_plan;
    ...
    public:
        bool kinova_routine(robot_grasp::G_pick_place::Request &req,robot_grasp::G_pick_place::Response &res);
        bool OperateGripper(bool close_gripper);

        //tf::Quaternion RPYToQuaternion(float R, float P, float Y);
        //geometry_msgs::PoseStamped cale_obj_pose_in_robot_base(float w_x,float w_y,float w_z);
    };
}
